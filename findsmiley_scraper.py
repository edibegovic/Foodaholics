        ...
        if pd.isnull(address):
            ...
            try:
                ...
                for entry in restaurant_list:
                    ...
                    entry_address = entry_element.find_element(By.CSS_SELECTOR,"div:nth-child(2) > p:nth-child(1)").text + ', ' + entry.find_element(By.CSS_SELECTOR,"div:nth-child(2) > p:nth-child(2)").text
